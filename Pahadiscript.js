(function () {
  ...
  const _0x5e548e = {
    k: "https://raw.githubusercontent.com/mahiuk/Aincrad-Key/main/key.txt",
    r: "https://raw.githubusercontent.com/mahiuk/Aincrad-Key/main/Pahadimods.txt",
    t: "https://raw.githubusercontent.com/mahiuk/Aincrad-Key/main/button.txt",
  ...
  (async function () {
    ...
    _0xd9eed1.innerHTML = `
      <h3 style="margin:0 0 10px 0;color:#00ffcc;font-size:18px;letter-spacing:1px;font-weight:bold;">PAHADI MODS</h3>
      ...
      <button id="rama-telegram-btn"
        style="width:100%;background:#229ED9;color:#fff;border:none;padding:12px;border-radius:6px;font-weight:bold;cursor:pointer;font-size:13px;">TELEGRAM RAMA MODZ</button>
  ...
  // CREDIT: @RAMA_MODZ
            ...
            let _0x566f72 = false;
            try {
              const _0x33201b = await fetch("https://rm.rama-modz.workers.dev/");
